...
lfixv = DrawStim.Quad(5, 15, cntx - deg1*iso + 60, cnty, 0.5,0.5,1)
lfixw = DrawStim.Quad(15,5, cntx - deg1*iso + 60, cnty, 0.5,0.5,1)
rfixv = DrawStim.Quad(5, 15, cntx + deg1*iso + 60, cnty, 0.5,0.5,1)
rfixw = DrawStim.Quad(15, 5, cntx + deg1*iso + 60, cnty, 0.5,0.5,1)
#  + deg1*0.7071068
